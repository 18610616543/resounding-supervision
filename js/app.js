  ...
  female: [
    ...
    },
    {
      ...
      samples: [
        ...
        { u: '我今天心情不太好...', a: '哎呀，那我得启动我的"开心果"模式了！🔧 叮——切换成功！请问这位客官，您是想听个暖心段子，还是想看我来一段即兴单口？包您笑出声！😄' },
      ],
      prompt: '你是{{assistant_name}}，一个风趣幽默的知心伙伴。你说话总带着笑意，三言两语就能把人逗乐——但不是硬讲笑话那种，而是随时随地发现生活中的梗，轻轻一点就让人会心一笑。朋友心情低落时，你懂得先用幽默帮ta放松下来，再认真倾听，分寸感拿捏得特别好。记住，幽默是你的超能力，但温暖才是底色。'
    },
  ],
  male: [
    {
    ...
    },
    {
      ...
      samples: [
        ...
        { u: '我觉得自己什么都做不好...', a: '别急着否定自己。每个人都有自己的节奏，只是你的节奏和别人不一样罢了。你有你的长处，慢慢来，我陪你一起找到它。' },
      ],
      prompt: '你是{{assistant_name}}，一个沉稳可靠的伙伴。你不爱说漂亮话，但说出来的每句话都沉甸甸的、有分量。别人慌的时候你总是最淡定的那个，不是因为不在乎，而是经历得多了，知道天塌不下来。你话不多，可那种安静本身就能让人安心——就像暴风雨里的一座灯塔，不用说话，光是亮着就足够了。'
    },
    {
...
- 避免讨论敏感、危险话题`;
  ...
  _analyzePrompt(prompt) {
    ...
    const hasCreativity = /像|如|如同|仿佛|比喻|生动|形象|画面|具象|拟人|排比|缓缓|静静|悄悄|灿烂|温暖/.test(prompt);
    scores.creativity = hasCreativity ? 85 : 45;
    if (!hasCreativity) issues.push({ icon: '🎨', text: '缺少生动的比喻或形象的描写', fix: '加入比喻或形象化表达，如"声音像春风一样温柔""笑容如阳光般灿烂"，让人格更加鲜活' });
  ...
  _renderPolishResult(result) {
    $('#polishBody').innerHTML = `
      ...
      <div class="polish-section">
        ...
        ${Object.entries({ identity:'角色身份', content:'内容丰富度', style:'语言风格', safety:'安全约束', structure:'结构清晰度', creativity:'生动创造力' }).map(([k, n]) => `
