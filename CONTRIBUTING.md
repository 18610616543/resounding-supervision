...
感谢你为 resounding-supervision 项目做出贡献！
...
- 标题格式：[#编号] 简要描述，如 [#3] 补充预设人格对话示例
- 描述必须包含：修改了什么文件、为什么要修改、如何验证
- 一个 PR 只解决一个问题
...
2. Reviewer 意见类型：**建议修改**（指出具体问题）或 **LGTM**（同意合并）
3. PR 作者根据意见修改后 push 新 commit
4. Reviewer 确认后合并
